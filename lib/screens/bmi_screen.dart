...
import 'package:flutter_bootcamp/shared/menu_bottom.dart';
import 'package:flutter_bootcamp/shared/menu_drawer.dart';
      ...
      SingleChildScrollView(
        child: Column(children: [
          ...
          Padding(
            ...
            child: TextField(controller: txtHeight, keyboardType: TextInputType.number, decoration: InputDecoration(
                hintText: heightMessage
            )),
          ),
          Padding(
            padding: const EdgeInsets.all(24.0),
            child: TextField(controller: txtWeight, keyboardType: TextInputType.number, decoration: InputDecoration(
                hintText: weightMessage
            )),
          ),
          ElevatedButton(onPressed: findBMI,
